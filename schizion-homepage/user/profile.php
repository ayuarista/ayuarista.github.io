         ...
         ?></h5>
                 ...
                 <li class="mt">
                  ...
                  <li class="sub-menu">
                      ...
                      <ulclass="sub">
                          <li  ><a  class="active" href="profil_patient.php">Patient</a></li>
                        ...
                        <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  <td>1</td>
                                  <td>Name</td>
                                  <td>Bidayatul Masulah</td>
                              </tr>
                              <tr>
                                  <td>2</td>
                                  <td>Email</td>
                                  <td>bidayatulmasulah@gmail.com</td>
                              </tr>
                              <tr>
                                  <td>3</td>
                                  <td>Age</td>
                              ...
                              <tr>
                                  <td>6</td>
                                  <td>Address</td>
                                  <td>Mulyorejo Utara NO.121 Surabaya</td>
                              </tr>
                              <tr>
                                  <td>7</td>
                                  <td>Last Result</td>
                                  <td><h5>YOUR RESULT : POSITIVE SCHIZOPHRENIA</h5>
                  <p>Your answers suggest you are suffering from schizophrenia critical level.</p>
                  <p>Consider immediate treatment to the nearest hospital</p></td>
                              </tr>
                              </tbody>
                          </table>
                        </div><! --/content-panel -->
