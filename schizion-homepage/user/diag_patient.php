         ...
         ?></h5>
                 ...
                 <li class="mt">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="active" href="diag_patient.php">Patient</a></li>
...
<input id="total" type="submit" name="submit" value="Submit"/>
</form>
...
$insert_user ="INSERT INTO result (cga_result,idusera_result,usera_result) values ('3','$u_id','$result')";
...
if ($insert_user) {
    echo "<script>window.open('diag_caregiver.php','_self')</script>";
}
